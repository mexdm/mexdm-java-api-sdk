...
import com.mexdm.dax.sdk.openapi.common.enums.HttpHeader;
import com.mexdm.dax.sdk.openapi.common.utils.SignatureUtils;
...
public class ApiClient {
    ...
    ApiClient(final ClientParameter parameter) {
    ...
    private class SignInterceptor implements Interceptor {
        ...
        SignInterceptor(final ClientParameter clientParameter) {
